...
class ControlTrainer(Trainer):
    ...
    def _train(self) -> None:
        ...
        ) # latent shape (2, 3, 4) [2: batch size, 3: height, 4: width]
        requires_gradient_step = True
        accumulated_loss = 0.0

        # [wjh] main training loop
        while (
            ...
            # 2. Prepare batch
            ## separate iterators for condition and latent data, based on "latents" shape
            try:
            ...
            if sampler.is_ready: # len(_satisfied_buckets)>0
