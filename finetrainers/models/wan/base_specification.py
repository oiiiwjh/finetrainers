    ...
    def __init__(
        ...
        **kwargs,
        ...
        if condition_model_processors is None:
            # condition_model_processors = [T5Processor(["encoder_hidden_states", "prompt_attention_mask"]),PluckProcessor(["encoder_hidden_states_image"])]
    ...
    def forward(
        ...
        **kwargs,
        ...
        if compute_posterior:
            ...
            latents = posterior.sample(generator=generator) # 从后验概率分布中采样
        ...
        if self.transformer_config.image_dim is not None:
            # wjh: noisy_latents 和 latent_condition 直接cat
